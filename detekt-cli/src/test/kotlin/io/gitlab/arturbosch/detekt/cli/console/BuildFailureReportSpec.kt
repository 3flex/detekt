...
internal class BuildFailureReportSpec : Spek({
    ...
    describe("reached extension function tests") {
        subject.apply {
            assertThat(0.reached(0)).isFalse()

            assertThat((-1).reached(0)).isFalse()

            assertThat(1.reached(0)).isFalse()
            assertThat(1.reached(1)).isTrue()
            assertThat(1.reached(2)).isTrue()

            assertThat(12.reached(11)).isFalse()
            assertThat(12.reached(12)).isTrue()
            assertThat(12.reached(13)).isTrue()
        }
    }
})
